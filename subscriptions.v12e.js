    ...
    cbInstance.load("components").then(() => {
      ...
      function PopulateFormFields(data) {
          ...
          if (data.card.status != null && data.card.status == "valid") {
              ...
              if ($.trim($('#card-number_frame #cardnumber').val()) == '' && data.card.masked_number != null) {
                  $('#card-number_frame #cardnumber').val(data.card.masked_number);
              }
              if ($.trim($('#card-number_frame #exp-date').val()) == '' && data.card.expiry_month != null && data.card.expiry_year != null) {
                  $('#card-number_frame #exp-date').val(data.card.expiry_month + '/' + data.card.expiry_year);
              }
