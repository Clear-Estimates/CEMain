...
Webflow.push(function () {
    ...
    $(document).ready(function () {
        ...
        if (hasCustomerId) {
            ...
            console.log(cbCustomerByIdApiUrl);
            $.get(cbCustomerByIdApiUrl, function (data) {
                if (data != null) {
                    
                    console.log(data);
                    if (data.customer != null && data.card != null) {
    ...
    function ChargebeeCreateSubscription(objSubscription, cedomain, email, hasCustomerId) {
        $.ajax({
            ...
            if (resp.success && resp.subscription_id != null && resp.subscription_id !== '') {
                ...
                if(!hasCustomerId) {
                    window.location.href = cedomain + '/subscribe/resubscribe-success?registrationtoken=' + resp.subscription_id + '&email=' + email;
                }
                else {
