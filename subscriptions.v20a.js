...
Webflow.push(function () {
    ...
    $(document).ready(function () {
        ...
        //var hasReturnUrlWithJobId = returnUrl != null && returnUrl.toLowerCase().indexOf('jobid') > 0;
        ...
        if (hasCustomerId) {
            ...
            //console.log('Plan ID:' + plan_id + '  ' + 'Plan Name:' + planName);
            ...
            grecaptcha.execute('6LflQdcpAAAAALgGp1Avv7Un6vWEbhNWrMaCdH7b', { action: 'submit' }).then(function (token) {
                ...
                $.ajax({
                    ...
                    if (resp.success && resp.subscription_id != null && resp.subscription_id !== '') {
                        ...
                        if (!hasCustomerId) {
                            window.location.href = cedomain + '/subscribe/success?registrationtoken=' + resp.subscription_id + '&email=' + email + '&phone=' + phone + '&fname=' + fname + '&lname=' + lname;
                        }
                        else {
