  ...
  Webflow.push(function() {
    ...
    var publishableCBKey = "test_sqbO05Vgy9CUM4P5jZrt53HiN0Xne8Ir"; //"live_3V5PE3cn04MqdLrPbcdoPS4yeafoxX1aK"
    ...
    $('#confirm-email, #email').on('keyup change', function () {
        ...
        if (emailError) {
            ...
            cbgetcustomersheader.append("Content-Type", "application/x-www-form-urlencoded");
            cbgetcustomersheader.append("Access-Control-Allow-Origin", "*");
            let requestOptions = { method: 'GET', headers: cbgetcustomersheader, cache: 'no-cache', mode: "no-cors" };
