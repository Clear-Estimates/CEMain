  ...
  Webflow.push(function() {
    ...
    cbInstance.load("components").then(() => {
      ...
      var wfImageUrl = "https://uploads-ssl.webflow.com/6144fd968952ef8fcdb1755a/64515d2162e55df60d1370c7_";
          ...
          if (data.card.status != null && data.card.status == "valid") {
              ...
              if (data.card.card_type != null && data.card.card_type != '' && data.card.last4 != null) {
                  ...
                  switch (data.card.card_type.toLowerCase()) {
                      case 'mastercard':
                          $('#img-card').attr('src', wfImageUrl + "mc.png");
                          cardText = 'Mastercard';
                          break;
                      case 'visa':
                          $('#img-card').attr('src', wfImageUrl + "visa.png");
                          cardText = 'Visa';
                          break;
                      case 'american_express':
                          $('#img-card').attr('src', wfImageUrl + "amex.png");
                          cardText = 'American Express';
                          break;
                      case 'discover':
                          $('#img-card').attr('src', wfImageUrl + "dc.png");
                          cardText = 'Discover';
                          break;
                  }
                  ...
                  $('#defaultPaymentBlock, .custom-payment-block').hide();
                  $('#lnkEditPayment').off('click').on('click', function () {
                      $('#lnkEditPayment').hide();
                      $('#defaultPaymentBlock, .custom-payment-block').show();
