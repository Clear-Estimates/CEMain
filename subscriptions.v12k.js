  ...
  Webflow.push(function() {
    ...
    $('#confirm-email, #email').on('change', function () {
        ...
        if (email != '' && !regex.test(email)) {
            ...
            if ($('#email-error').length == 0) {
                $('#email').css("margin-bottom", "2px");
                $('<div id="email-error"><label style="padding-top:2px;color:#e96c6a;font-size: 14px;margin-bottom: 5px;">Email address is required</label></div>').insertAfter("#email");
            }
            $('#email').focus();
            emailError = true;
        }
        ...
        if (email != '' && confirmemail != '') {
            ...
            if ($('#confirm-email-error').length == 0) {
                $('#confirm-email').css("margin-bottom", "2px");
                $('<div id="confirm-email-error"><label style="padding-top:2px;color:#e96c6a;font-size: 14px;margin-bottom: 5px;">Confirm email address is required</label></div>').insertAfter("#confirm-email");
            }
            $('#confirm-email').focus();
            emailError = true;
        }
