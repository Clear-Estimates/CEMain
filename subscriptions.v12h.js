  ...
  Webflow.push(function() {
    ...
    var cbdomain = "https://clearestimates.chargebee.com/"; //https://clearestimates-test.chargebee.com/
    var cedomain = "https://www.clearestimates.com";//"https://newsite.clearestimates.com"
    var ceproxydomain = "https://webflow.clearestimates.com/ce-chargebee/subscriptions";
    var cbSite = "clearestimates"; //"clearestimates-test"
    var publishableCBKey = "live_o5QtQkI1l71FdTp731uX7RcyoDPDUFBZ"; //"test_NLnmWzIrJCKIUfkNfirdY7x5JUQfhmHI"
    ...
    $('#confirm-email, #email').on('keyup change', function () {
        ...
        if (emailError) {
            ...
            var cbgetcustomerurl = cbdomain + "api/v2/customers?email[is]=" + encodeURIComponent(email) + "&sort_by[desc]=created_at&limit=1";
            var cbgetcustomersheader = new Headers();
            cbgetcustomersheader.append("Authorization", "Basic " + btoa("live_o5QtQkI1l71FdTp731uX7RcyoDPDUFBZ:"));
            console.log('Key = ' + btoa("live_o5QtQkI1l71FdTp731uX7RcyoDPDUFBZ:"));
            cbgetcustomersheader.append("Content-Type", "application/json");
            cbgetcustomersheader.append("Access-Control-Allow-Origin", "*");
            let requestOptions = { method: 'GET', headers: cbgetcustomersheader, cache: 'no-cache', redirect: 'follow' };
            ...
            $.ajax({
                ...
                beforeSend: function (xhr) {
                    ...
                    xhr.setRequestHeader("Origin", "https://newsite.clearestimates.com")
                },
